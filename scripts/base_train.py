...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="nanochat-jp", name=args.run, config=user_config)
...
train_loader = tokenizing_distributed_data_loader_with_state_bos_bestfit(tokenizer, args.device_batch_size, args.max_seq_len, split="train", device=device, resume_state_dict=dataloader_resume_state_dict, prefetch_batches=args.dataloader_prefetch_batches)
build_val_loader = lambda: tokenizing_distributed_data_loader_bos_bestfit(tokenizer, args.device_batch_size, args.max_seq_len, split="val", device=device, prefetch_batches=args.dataloader_prefetch_batches)
